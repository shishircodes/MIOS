...
import type { FeatureSetting, LlmProvider, LlmRoute } from '~/lib/types'
  ...
  return (
    <div className="page">
      <div className="page-header">
        <div>
          <div className="kicker">Admin · AI models</div>
      ...
      {spent && (
        <div className="notice err" role="status">
          ...
          <Link to="/usage">See usage &amp; cost</Link>
        </div>
      )}
      ...
      {/* Switches for what the models are asked to do at all, as opposed to
          which model does it. Kept apart so turning a feature off is not
          mistaken for choosing a model. */}
      {data.pushRationale && (
